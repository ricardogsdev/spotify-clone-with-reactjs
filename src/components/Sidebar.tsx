  ...
  return (
    <aside className="w-72 bg-zinc-950 p-6">
          ...
          <nav className="mt-6 pt-6 border-t border-zinc-800 flex flex-col gap-3">
            ...
            <a href="#" className="text-sm text-zinc-400 hover:text-zinc-100">Top #100</a>
            <a href="#" className="text-sm text-zinc-400 hover:text-zinc-100">Viral Funk</a>
            <a href="#" className="text-sm text-zinc-400 hover:text-zinc-100">Top Brasil</a>
            <a href="#" className="text-sm text-zinc-400 hover:text-zinc-100">Top 50 Global</a>
